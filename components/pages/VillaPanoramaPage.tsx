      ...
      <div className="container">
        ...
        <div className="flex gap-8 flex-col lg:flex-row">
          <div className="w-full lg:w-2/3 mx-auto">
            ...
            <div className="py-10">
              <Markdown>{VillaDescriptionData.data[0].des}</Markdown>
              <h2 className="text-md font-ExtraBold mt-4">
                <Markdown>{VillaDescriptionData.data[0].subtitle}</Markdown>
              </h2>
              <Markdown>{VillaDescriptionData.data[0].des2}</Markdown>
              <h2 className="font-ExtraBold text-md mt-4">
                <Markdown>{VillaDescriptionData.data[0].subtitle2}</Markdown>
              </h2>
              <Markdown>{VillaDescriptionData.data[0].des3}</Markdown>
            </div>
            <hr />
            <div className="py-10">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2">
                {FeaturesData.data.slice(0, 6).map((item, index) => (
                  ...
                  >
                    <Image src={item.icon} alt={item.icon_alt} sizes="48px" />
              ...
              {showFeatures && (
                <FeaturesComponent handleClose={() => setShowFeatures(false)} />
              )}
            </div>
            <hr />
            <div className="py-10">
